...
<form action="{{ route($route, $race->id) }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="space-y-8 divide-y divide-gray-200 dark:divide-gray-800 fallback">
        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div class="sm:col-span-6">
                <label for="cover_photo" class="block text-sm font-medium text-gray-700 dark:text-gray-200">
                    Upload Results
                </label>
                <div
