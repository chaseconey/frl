                ...
                <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
                    <nav class="relative flex items-center justify-between sm:h-10 lg:justify-start"
                        ...
                        <div class="hidden md:block md:ml-10 md:pr-4 md:space-x-8">
                            <a href="#league" class="font-medium text-gray-500 hover:text-gray-900">League Benefits</a>
                            <a href="https://discord.gg/73u3p54" target="_blank"
                               class="font-medium text-gray-500 hover:text-gray-900">Discord</a>
                ...
                <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                    <div class="sm:text-center lg:text-left">
                        <h1 class="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            ...
                            <span class="block text-indigo-600 xl:inline">F1 2020</span>
                        </h1>
    ...
    <div class="bg-white" id="league">
        <div class="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8">
            <div class="max-w-3xl mx-auto text-center">
                <h2 class="text-3xl font-extrabold text-gray-900">League Benefits</h2>
                <p class="mt-4 text-lg text-gray-500">FRL offers a plethora of benefits above and beyond clean, quality races.</p>
            </div>
